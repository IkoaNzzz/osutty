...
class DockTilePlugin: NSObject, NSDockTilePlugIn {
    ...
    #if DEBUG
    private let ghosttyUserDefaults = UserDefaults(suiteName: "io.github.ikoanzzz.osutty.debug")
    #else
    private let ghosttyUserDefaults = UserDefaults(suiteName: "io.github.ikoanzzz.osutty")
    #endif
